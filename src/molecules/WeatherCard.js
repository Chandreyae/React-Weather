    ...
    const fetchData = async () => {
      try {
        ...
        if (userInputLocation === null) {
          ...
          fetchedCitiesGeoLocation = await axios.get(
            `https://api.openweathermap.org/geo/1.0/direct?q=${userInputLocation}&limit=5&appid=11ab70ad14039b5b8971613e0c1c91b6`
          );
          result = await axios.get(
            ...
            <Grid item xs={12}>
              <Grid container spacing={2}>
                {weatherForecast !== null &&
                  weatherForecast.daily !== undefined &&
